...
class RankRecyclerViewAdapterMap(onLoadMoreListener: OnLoadMoreListener) :
    ...
    var itemList=ArrayList<RecyclerRankingItem>()
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return ViewHolder(
                LayoutInflater.from(parent.context).inflate(
                    R.layout.recycler_rankfragment_item,
                    parent,
                    false
                )
            )
    ...
    fun addAll(lst: ArrayList<RecyclerRankingItem>) {
        //itemList.clear()
        itemList.addAll(lst)
        notifyDataSetChanged()
    }

    fun addItemMore(lst: List<RecyclerRankingItem>) {
        itemList.addAll(lst)
    ...
    internal class ViewHolder(v: View) : RecyclerView.ViewHolder(v) {
        ...
        init {
            rank = v.findViewById(R.id.rankingFragmentCountTextView) as TextView
            mapTitle = v.findViewById(R.id.rankingFragmentMapTitleTextView) as TextView
            execute = v.findViewById(R.id.rankingFragmentExecuteTextView) as TextView
